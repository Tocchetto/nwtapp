...
getSuffix <- function(variable){ #Tem que ver certinho as unidades de cada valor (pressão, velocidade do vento, altura...)
  ...
  if(variable == "USSL" || variable == "MDNV" || variable == "LWNV" || variable == "HINV")return(" 0-1")
  if(variable == "UZRS" || variable == "USSL" || variable == "UR2M") return(" %")
...
#     mapRaster <- paste('Tifs/Eta_MIROC5/Eta_MIROC5_20_',variableType,'_climate_annually_',variable,'_', dec, '0101_0000_v1.tif', sep = "")
#     r <- raster(mapRaster,layer=10)
#     pal <- colorNumeric(c("#00CC00", "#339933", "#339933", "#006600", "#006600", "#000000"), c(25, 25, 50, 50, 75, 75),
...
#     mapRaster <- paste('Tifs/Eta_MIROC5/Eta_MIROC5_20_',variableType,'_climate_annually_',variable,'_', dec, '0101_0000_v1.tif', sep = "")
#     r <- raster(mapRaster,layer=10)
#     pal <- colorNumeric(c("#066867", "#31BFC1", "#78D0DC", "#ACE0EB", "#FDDEBF", "#FBAA6B", "#CF6028", "#5E260F"), 
...
#     mapRaster <- paste('Tifs/Eta_MIROC5/Eta_MIROC5_20_',variableType,'_climate_annually_',variable,'_', dec, '0101_0000_v1.tif', sep = "")
#     r <- raster(mapRaster,layer=10)
#     pal <- colorNumeric(c("#6699FF", "#6699FF", "#66FF99", "#FFFF99", "#FFCC66", "#FFCC66", "#FF0000", "#FF0000", "#990099", "#990099"), 
#                         c(0,3,4,5,6,7,8,9,10,12), na.color = "transparent")
#     return(pal)
#   }
#   if(variable == "TP2M" || variable == "TSFC" || variable == "DP2M" || variable == "TGSC" || variable == "TGRZ" || 
...
#     mapRaster <- paste('Tifs/Eta_MIROC5/Eta_MIROC5_20_',variableType,'_climate_annually_',variable,'_', dec, '0101_0000_v1.tif', sep = "")
#     r <- raster(mapRaster,layer=10)
#     pal <- colorNumeric(c("#E2F2FA", "#BCEEFB", "#BCEEFB", "#B9ECD8", "#CADB92", "#FFEB88", "#FBC25E", "#FF7B33", "#CD5B12", "#FF3C1C", "#663399"), 
#                         c(-5,0,5,10,15,20,25,30,35,40,45), na.color = "transparent")
#     return(pal)
#   }
#   else{
#     mapRaster <- paste('Tifs/Eta_MIROC5/Eta_MIROC5_20_',variableType,'_climate_annually_',variable,'_', dec, '0101_0000_v1.tif', sep = "")
...
getShapeValues <- function(variable){
  if(variable == "MDNV" || variable == "LWNV" || variable == "HINV"){
    return(c(-5,0,5,10,15,20,25,30,35,40,45))
  }
  if(variable == "RNSG" || variable == "RNOF" || variable == "EVTP" || variable == "EVPP" || variable == "NEVE" || 
     variable == "PREC"){
    return(c(-5,0,5,10,15,20,25,30,35,40,45))  
  ...
  if(variable == "W100" || variable == "W10M" || variable == "D10M" || variable == "D100"){
    return(c(0,3,4,5,6,7,8,9,10,12))  
  }
  if(variable == "TP2M" || variable == "TSFC" || variable == "DP2M" || variable == "TGSC" || variable == "TGRZ" || 
     variable == "MXTP" || variable == "MNTP"){
    return(c(-5,0,5,10,15,20,25,30,35,40,45))  
